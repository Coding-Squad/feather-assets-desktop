    ...
    public partial class AssetRegistration : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ////con.Open();
                ////SqlCommand cmd = new SqlCommand("insert into Asset(rfid_tag,name,description,image,take_out_allowed,take_out_info,created_at,updated_at) values (@rfid_tag,@name,@description,@image,@take_out_allowed,@take_out_info,@created_at,@updated_at)", con);
                ...
                ////cmd.Parameters.AddWithValue("@image", img_arr1);
